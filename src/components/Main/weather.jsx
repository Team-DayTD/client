        ...
        <div className='weather'>
            ...
            :<section className='weatherContainer'>
                ...
                <div className='weatherBox'>
                    <img className='weatherImg' src={process.env.PUBLIC_URL + '/images/sun.png'} alt=""/>
                    <ul className='temperature'>
                        ...
                        <li className='location'><FontAwesomeIcon className='locIcon' icon={faLocationDot} />서대문구</li>
                    </ul>
                </div>
            </section>
